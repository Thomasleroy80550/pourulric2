...
const MigrationNotice: React.FC<MigrationNoticeProps> = ({ message }) => {
  ...
  return (
    <Alert variant="default" className="m-4 max-w-lg mx-auto bg-blue-100 border-blue-300 text-blue-800 dark:bg-blue-900/30 dark:border-blue-700 dark:text-blue-300">
