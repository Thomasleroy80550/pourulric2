...
const AdminBilan2025PrintLayout = ({
  ...
  return (
    <div id="admin-bilan-2025-to-print" className="w-[900px] bg-white text-black">
      <div className="px-8 py-6 border-b">
        <h1 className="text-2xl font-bold">Bilan annuel — {clientName}</h1>
      ...
      <div className="px-8 py-6 grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <div className="text-sm text-gray-600">Volumes annuels</div>
          <div className="rounded-lg border p-4 space-y-2">
