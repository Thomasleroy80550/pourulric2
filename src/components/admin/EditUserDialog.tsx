...
const editUserSchema = z.object({
  ...
  notify_booking_change_sms: z.boolean().optional(),
  ...
  useEffect(() => {
    if (isOpen && user) {
      form.reset({
        ...
        notify_booking_change_sms: user.notify_booking_change_sms ?? false,
                ...
                <TabsContent value="notifications" className="mt-4">
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <FormField control={form.control} name="notify_booking_change_sms" render={({ field }) => (<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm"><div className="space-y-0.5"><FormLabel>Modifications par SMS</FormLabel><FormDescription>Envoie un SMS court lors d'un changement de réservation.</FormDescription></div><FormControl><Switch checked={field.value} onCheckedChange={field.onChange} /></FormControl></FormItem>)} />
