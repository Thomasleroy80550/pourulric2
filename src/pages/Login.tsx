                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          disabled={loading}
                          className="h-14 md:h-16 rounded-md bg-[#175e821a] px-4 text-[#0A2540] placeholder:text-[#175e82b3] shadow-inner border border-transparent focus:bg-white focus:border-[#175e82e6]"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
