...
import SpatialTunnelLoader from '@/components/SpatialTunnelLoader'; // Import the new loader
...
const NewOwnerSitePage: React.FC = () => {
  ...
  return (
    <>
      {isLoading && <SpatialTunnelLoader />}
      <MainLayout>
        <div className={`container mx-auto py-6 transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
