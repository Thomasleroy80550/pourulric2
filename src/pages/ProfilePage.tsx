          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Input id="address" value={propertyAddress} onChange={(e) => setPropertyAddress(e.target.value)} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="city">Ville</Label>
                <Input id="city" value={propertyCity} onChange={(e) => setPropertyCity(e.target.value)} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="zipCode">Code postal</Label>
                <Input id="zipCode" value={propertyZipCode} onChange={(e) => setPropertyZipCode(e.target.value)} />
              </div>
            </CardContent>
          </Card>

          {/* Préférences de paiement pour Airbnb et Booking.com */}
          <Card>
            <CardHeader>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="ibanAirbnb" value={ibanAirbnbBooking} onChange={(e) => setIbanAirbnbBooking(e.target.value)} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="bicAirbnb">BIC</Label>
                <Input id="bicAirbnb" value={bicAirbnbBooking} onChange={(e) => setBicAirbnbBooking(e.target.value)} />
              </div>
            </CardContent>
          </Card>

          {/* Préférences de paiement pour Abritel et Hello Keys */}
          <Card>
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center space-x-2">
                <Switch id="syncHellokeys" checked={syncWithHellokeys} onCheckedChange={setSyncWithHellokeys} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="ibanAbritel" value={ibanAbritelHellokeys} onChange={(e) => setIbanAbritelHellokeys(e.target.value)} disabled={!syncWithHellokeys} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="bicAbritel">BIC</Label>
                  <Input id="bicAbritel" value={bicAbritelHellokeys} onChange={(e) => setBicAbritelHellokeys(e.target.value)} disabled={!syncWithHellokeys} />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="linenType" value={linenType} onChange={(e) => setLinenType(e.target.value)} />
              </div>
              <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch id="notif-new-booking-email" checked={notifyNewBookingEmail} onCheckedChange={setNotifyNewBookingEmail} />
              </div>
              <div className="flex items-center justify-between">
                <Label htmlFor="notif-cancel-email">Recevoir les annulations par email</Label>
                <Switch id="notif-cancel-email" checked={notifyCancellationEmail} onCheckedChange={setNotifyCancellationEmail} />
              </div>
              <div className="flex items-center justify-between">
                <Label htmlFor="notif-new-booking-sms">Recevoir les nouvelles réservations par SMS</Label>
                <Switch id="notif-new-booking-sms" checked={notifyNewBookingSms} onCheckedChange={setNotifyNewBookingSms} />
              </div>
              <div className="flex items-center justify-between">
                <Label htmlFor="notif-cancel-sms">Recevoir les annulations par SMS</Label>
                <Switch id="notif-cancel-sms" checked={notifyCancellationSms} onCheckedChange={setNotifyCancellationSms} />
              </div>
            </CardContent>
          </Card>
